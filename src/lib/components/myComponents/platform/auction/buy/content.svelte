<script>
  ...
  import PriceHistoryChart from "./priceHistoryChart.svelte";
    ...
    let timerData = { hours: 24, minutes: 0, seconds: 0 }; // 1 day
      ...
      <div class="w-full flex flex-col sm:grid grid-cols-2 sm:px-8 gap-16">
        ...
        <div class=" w-full flex flex-col gap-8">
          <div class="border-2 p-2 flex flex-col gap-4">
            ...
            <div class="flex justify-between items-end">
              <div class="flex flex-col gap-1">
                <div class="text-zinc-400 text-xs">Price range</div>
          ...
          <div class="border-2 p-2 flex flex-col gap-4">
            ...
            <div class="flex justify-between items-end">
              <div class="flex flex-col gap-1">
                <div class="text-zinc-400 text-xs">Current bid</div>
                <div class="text-md flex gap-1 items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                    ...
                    /></svg
                  >
                  <div class="">0.79 <span class="text-sm text-zinc-400">(YOU)</span></div>
                </div>
              </div>
              <div class="flex flex-col gap-1">
                <div class="text-zinc-400 text-xs">Ends in</div>
                <div class="text-md flex gap-1 items-center">
                  <CountDown time={timerData} />
                </div>
              </div>
            </div>
          </div>
