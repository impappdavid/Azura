...
<div class="w-full max-w-8/12 h-full flex gap-8 justify-center items-center">
    ...
    <div class="z-50 flex sm:flex-row flex-col gap-8 items-center justify-center">
        <img
            src={imageUrl}
            alt="def1"
            class="w-full h-full max-w-[500px] max-h-[500px] border-2 border-zinc-600 z-50"
        />
        <svg
        ...
        >
        <div
            class="w-full h-full text-md text-xs sm:min-w-[500px] max-w-[500px] sm:min-h-[500px] max-h-[500px] border-2 border-zinc-600 bg-zinc-600/50 z-50 font-body flex justify-center items-center"
        >
            Select another NFT
        </div>
    </div>
