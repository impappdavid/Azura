<script>
  ...
  import Button from "$lib/components/ui/button/button.svelte";
    import SaleOrder from "./saleOrder.svelte";
      ...
      <div class="w-full grid grid-cols-2 px-8 gap-16">
        <div class="w-full">
          <img
            src={auro}
            alt="auro"
            class="aspect-square w-fit max-h-[700px] border-2"
          />
        </div>
        <div class=" w-full flex flex-col gap-8">
          ...
          <Tabs.Root value="sell" class="w-full">
            <Tabs.List class="bg-transparent">
              <Tabs.Trigger value="sell" class="bg-transparent"
                >Sell</Tabs.Trigger
              >
              <Tabs.Trigger value="auction" class="bg-transparent"
                >Auction</Tabs.Trigger
              >
            </Tabs.List>
