...
{#each data as sale}
    <div
        class="h-full max-h-[240px] w-full max-w-[180px] transition-all duration-300 ease-in-out relative rounded-xl cursor-pointer group"
    >
        <div class="relative overflow-hidden rounded-t-xl h-[200px]">
            <img
                src={sale.url}
                alt="nft"
        ...
        >
            <div
                class="text-xs text-zinc-200 hover:text-red-500 transition-all"
            >
                <svg
        ...
        <div class="h-fit bg-white rounded-b-xl flex justify-between px-2 py-1">
            <div class="flex flex-col text-start gap-0">
                <div
                    class="text-zinc-600 font-body text-xs font-medium flex gap-1"
                >
                    {sale.character}
                    <div class="text-[10px]">
                        #{sale.tokenId}
                ...
                <div class="text-black font-body font-semibold text-sm">
                    {sale.price}
                    <span class="text-zinc-600 font-medium text-xs">SOL</span>
                </div>
            </div>
