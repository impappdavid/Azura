...
{#each data as sale}
    <div
        class="h-full max-h-[340px] w-full max-w-[210px] transition-all duration-300 ease-in-out relative rounded-xl cursor-pointer group"
    >
        ...
        <div class="h-fit bg-white flex flex-col gap-1 px-3 py-2 text-start">
